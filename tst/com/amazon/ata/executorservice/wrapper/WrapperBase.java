package com.amazon.ata.executorservice.wrapper;
...
//    }
    ...
    protected static Object invokeInstanceMethodWithReturnValue(
        ...
        try {
            ...
            fail(String.format("Unable to access %s on %s",
                    method.getName(),
                    invokeTarget.getClass().getSimpleName()), e);
        } catch (InvocationTargetException e) {
            fail( String.format("Failed to successfully call %s on %s",
                    method.getName(),
                    invokeTarget.getClass().getSimpleName()), e.getCause());
        }
    ...
    protected static Object invokeStaticMethodWithReturnValue(final Method method, Object... args) {
        ...
        try {
            ...
            fail(String.format("Failed to successfully call %s on %s",
                    method.getName(),
                    method.getDeclaringClass().getSimpleName()), e.getCause());
        }
